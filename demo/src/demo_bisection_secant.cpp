/// \file BisectionSecant.cpp
/// This is a demonstration of how to use Secant.h<br />
/// to compile:  g++ -I../include -lm BisectionSecant.cpp<br />
...
int main() {
  double x0=1.0, x1=7, fx0, fx1;
  secant_functor sf( 5);

  stradle_value( x0, x1, fx0, fx1, 0.0, sf, &secant_functor::f);

  Bisection_Secant< secant_functor, double > foobar( 1.0, 10.0, 0.0, 1e-8, 1e-8, 100, sf, &secant_functor::f);
