/// \file rote_binomial.cpp
/// \brief This file contains the rote member functions of class binomial_option.
#include <iostream>
#include "simpleoption/binomial.h"

const char *binomial_option::_error_msg;
int binomial_option::_erno;
...
int binomial_option::check_attributes(
      double S,
      double K,
      double Tau,
      double Alpha,
